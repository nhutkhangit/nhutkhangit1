<form action="index.php?page=baiviet&act=sua&id=<?php echo $mang[0];?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
    ...
    <tbody>
      <tr>
        ...
        <td class="fr_2"><select name="iddm" id="iddm" validate="required:true">
          ...
          <?php
				...
				{
					?>
          <option value="<?php echo $rowdm[0];?>"<?php if($mang[1]==$rowdm[0]){?> selected="selected"<?php }?>><?php echo $rowdm[2];?></option>
          <?php
				}
		  ?>
        </select></td>
      ...
      <tr>
        ...
        <td class="fr_2"><label>
          ...
          <img src="../data/baiviet/<?php echo $mang[3];?>"  width="150" height="70"/>
        </label></td>
      </tr>
      <tr>
