<form action="index.php?page=logo&act=sua&id=<?php echo $mang[0];?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table align="center" border="0" width="100%">
    <tbody>
      <tr>
        <td class="title" align="center" width="100%"><strong>Cập nhập logo show</strong></td>
      </tr>
    </tbody>
  </table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="fr_2"><label>
          ...
          <img src="../data/logo/<?php echo $mang[1];?>"  width="150" height="50"/>
        </label></td>
      </tr>
      <tr>
