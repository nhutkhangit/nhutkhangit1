<form action="index.php?page=slide&act=sua&id=<?php echo $mang[0];?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="fr_2"><label>
          ...
          <img src="../data/slide/<?php echo $mang[1];?>"  width="150" height="50"/>
        </label></td>
      </tr>
      <tr>
