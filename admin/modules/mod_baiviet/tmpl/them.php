<form action="index.php?page=baiviet&act=them" method="post" enctype="multipart/form-data" name="form1" id="form1">
      ...
      <tr>
        ...
        <td class="fr_2"><label>
          ...
          <?php
            ...
            <option value="<?php echo $rowdm[0];?>"><?php echo $rowdm[2];?></option>
                    <?php
				}
		  ?>
          </select>
