    ...
    <div id="wrapper">
          ...
          <div class="container">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lorem Ipsum is simply dummy text of the printing and typesetting industry</li>
              </ol>
            </nav>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
              <div class="detail-section">
                <img src="assets/images/slider-1.jpg" alt="slider-1.jpg" class="w-100" />
                <div class="content-article">
                  <h2>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h2>
                  <div class="info-sm">
                    <span> Người đăng: Admin </span>
                    <span> Ngày đăng: 15/11/2019 </span>
                    <span><i class="fas fa-eye"></i> 10 lượt xem</span>
      ...
      <footer class="footer">
        <div class="footer-body">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <h2>Về tôi</h2>
                <p>Jack, Cam, Khói, Hương Ly, Hiếu Bến Tàu, Anh Vi Cá, Chị 13</p>
        ...
        <div class="footer-bottom">
          <h2>Copyrights © 2020 nhutkhangit.xyz</h2>
        </div>
        <!-- footer bottom -->
      </footer>
      <!-- footer -->
