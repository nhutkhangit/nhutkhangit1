...
Tags:  post, WordPress post, post slider, carousel post, widget, post widget, post slider widget, carousel post widget, feature image slide.
...
Smooth slider - post, featured image and post with Thumbnail. This plugin offers three post slider widget with viewing options.
...
3. Select tr-post-slider-widget.zip from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

Using FTP

1. Download tr-post-slider-widget.zip
2. Extract the tr-post-slider-widget directory to your computer
3. Upload the tr-post-slider-widget.zip directory to the /wp-content/plugins/ directory
...
1. Widget Create After Active This Plugin.

2. TR Post Slider Widget.

3. TR Post Featured image widget.
